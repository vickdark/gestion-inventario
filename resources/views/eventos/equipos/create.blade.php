    ...
    <div class="row mb-4">
        <div class="col-12 d-flex align-items-center justify-content-between">
            <div>
                ...
                <h3 class="fw-bold mb-0">Registrar Nuevo Equipo</h3>
            </div>
        ...
        <div class="col-lg-10">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('eventos.equipos.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row g-4">
                            <!-- Imagen del Equipo -->
                            <div class="col-md-4">
                                ...
                                <div class="image-upload-wrapper bg-light rounded-4 d-flex align-items-center justify-content-center position-relative overflow-hidden border-dashed" style="height: 250px; border: 2px dashed #dee2e6;">
                                    <div class="text-center p-3" id="preview-placeholder">
                                        ...
                                        <p class="small text-muted mb-0">Haz clic para subir o arrastra una imagen</p>
                                        <span class="text-muted" style="font-size: 0.7rem;">PNG, JPG (Máx. 2MB)</span>
                                    </div>
                            ...
                            <div class="col-md-8">
                                <div class="row g-4">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control rounded-3 @error('nombre') is-invalid @enderror" id="nombre" name="nombre" value="{{ old('nombre') }}" placeholder="Ej: Bafle JBL 15', Silla Tiffany, etc." required>
                                    ...
                                    <div class="col-md-6">
                                        <label for="estado" class="form-label fw-bold text-muted small text-uppercase">Estado Inicial</label>
                                        <select class="form-select rounded-3 @error('estado') is-invalid @enderror" id="estado" name="estado" required>
                                            ...
                                            <option value="Baja" {{ old('estado') == 'Baja' ? 'selected' : '' }}>Fuera de Servicio (Baja)</option>
                                        </select>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control border-start-0 rounded-end-3 @error('cantidad_total') is-invalid @enderror" id="cantidad_total" name="cantidad_total" value="{{ old('cantidad_total', 1) }}" required>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control rounded-3 @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" rows="4" placeholder="Especificaciones técnicas, dimensiones, etc.">{{ old('descripcion') }}</textarea>
                            ...
                            <div class="col-12 mt-5">
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-primary btn-lg rounded-pill fw-bold shadow-sm">
                                        <i class="fa-solid fa-floppy-disk me-2"></i> Guardar Equipo en Inventario
                                    </button>
                                </div>
                            </div>
                        </div>
