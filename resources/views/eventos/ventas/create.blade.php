...
<div class="container-fluid py-4">
    <form action="{{ route('eventos.ventas.store') }}" method="POST" id="venta-form">
        @csrf
        <div class="row">
            ...
            <div class="col-lg-8">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="date" name="fecha_venta" class="form-control rounded-3" value="{{ old('fecha_venta', date('Y-m-d')) }}" required>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body">
                        ...
                        <textarea name="notas" class="form-control rounded-3" rows="3" placeholder="Notas internas, términos...">{{ old('notas') }}</textarea>
                    </div>
                </div>
            </div>
