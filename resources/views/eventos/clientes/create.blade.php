    ...
    <div class="row mb-4">
        <div class="col-12 d-flex align-items-center justify-content-between">
            <div>
                ...
                <h3 class="fw-bold mb-0">Crear Nuevo Cliente</h3>
            </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('eventos.clientes.store') }}" method="POST">
                        @csrf
                        <div class="row g-4">
                            <!-- Tipo de Cliente -->
                            <div class="col-12">
                                ...
                                <div class="d-flex gap-4">
                                    <div class="form-check custom-radio">
                                        <input class="form-check-input" type="radio" name="tipo" id="tipo_persona" value="Persona" checked>
                                        <label class="form-check-label fw-semibold" for="tipo_persona">
                                            Persona Natural
                                        </label>
                                    </div>
                                    <div class="form-check custom-radio">
                                        <input class="form-check-input" type="radio" name="tipo" id="tipo_empresa" value="Empresa">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control border-start-0 rounded-end-3 @error('nombre') is-invalid @enderror" id="nombre" name="nombre" value="{{ old('nombre') }}" placeholder="Ej: Juan Pérez o Eventos S.A.S" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control border-start-0 rounded-end-3 @error('documento') is-invalid @enderror" id="documento" name="documento" value="{{ old('documento') }}" placeholder="Opcional">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control border-start-0 rounded-end-3 @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="ejemplo@correo.com">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control border-start-0 rounded-end-3 @error('telefono') is-invalid @enderror" id="telefono" name="telefono" value="{{ old('telefono') }}" placeholder="Ej: 300 123 4567">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control border-start-0 rounded-end-3 @error('direccion') is-invalid @enderror" id="direccion" name="direccion" value="{{ old('direccion') }}" placeholder="Calle, Carrera, Ciudad...">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control rounded-3 @error('notas') is-invalid @enderror" id="notas" name="notas" rows="4" placeholder="Alguna observación sobre este cliente...">{{ old('notas') }}</textarea>
